<x-admin-layout>
    ...
    <div class="py-12 center">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-blue-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.menus.update', $menu->id) }}"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div>
                                <img class="w-20 h-20" src="{{ asset('images/menus/' . $menu->image) }}" alt="">
                            </div>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number" min="0.00" max="10000000.00" id="price" name="price"
                                    value="{{ $menu->price }}"
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <textarea id="description" rows="3" name="description"
                                    ...
                                    @error('name') border-red-400 @enderror">{{ $menu->description }}</textarea>
                        ...
                        <div class="mt-6 p-4">
                            <button type="submit"
                                class="px-4 py-2 bg-red-400 hover:bg-red-700 rounded-lg text-white">Save</button>
                        </div>
                    </form>
                </div>
