    ...
    <div class="container w-full px-5 py-6 mx-auto">
        ...
        <body>
            ...
            <div class="main-content">
                ...
                <p class="main-content__body" data-lead-id="main-content-body">Cảm ơn quý khách đã đặt bàn của nhà hàng.
                    Yêu cầu của quý khách sẽ được xử lý và nhân viên sẽ liên hệ với quý khách sau vài phút nữa !</p>
            </div>
