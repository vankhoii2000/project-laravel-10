<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        style="background-image: url('images/banner/banner.jpg')">
        <h1
            class="font-mono text-3xl
        font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 md:text-center
        sm:leading-none lg:text-5xl">
            <span class="inline md:block">Welcome To Flower Restaurant</span>
        </h1>
        <div class="mx-auto mt-2 text-black-50 md:text-center lg:text-lg">
            Cảm ơn quý khách đã đến với nhà hàng Flower. Rất hân hạnh dược phục vụ mọi khách hàng đến với nhà hàng !
        </div>
    ...
    <section class="px-2 py-32 bg-white md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        <h3 class="text-xl">CÂU CHUYỆN CỦA NHÀ HÀNG
                        </h3>
                        <h2 class="text-4xl text-green-600">Xin chào!</h2>
                        <!-- </h1> -->
                        <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                            Suy nghĩ khác biệt tạo nên giá trị đặc biệt. Năm 2023 là năm cột mốc đánh dấu cho sự ra đời
                            của Flower Restaurant. Trong hành trình
                            năm phát triển, nhà hàng đã tạo ra giá trị và đặt vị trí khách hàng lên hàng đầu, tận tâm
                            phục vụ khách hàng. Sự thoải mái của khách hàng khi đến với nhà hàng là ưu tiên hàng đâu của
                            chúng tôi.
                        </p>
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-full overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <center><img src="{{ url('images/banner/banner1.jpg') }}" /></center>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        <h2 class="mb-4 text-2xl font-bold">Liên hệ</h2>
                        <h2
                        ...
                        <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
                            Sự thoải mái của khách hàng là ưu tiên hàng đầu. Với các món ăn được làm từ các đầu bếp nổi
                            tiếng với tay nghề lâu năm được đánh giá cao trong nhiều cuộc thi ẩm thực nổi tiếng!</p>
                        <ul>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Xử lý và giao hàng nhanh</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span class="font-medium text-gray-500">Thanh toán đa dạng</span>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <svg class="w-8 h-8 text-gray-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span class="font-medium text-gray-500">Món ăn đa dạng</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="grid lg:grid-cols-4 gap-y-6">
                @foreach ($menus as $menu)
                    <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                        <center><img class="w-50 h-48" src="{{ asset('images/menus/' . $menu->image) }}"
                                alt="Image" />
                            <div class="px-6 py-4">
                            ...
                            <div class="flex items-center justify-between p-4">
                                <span class="text-xl text-red-600"> {{ number_format($menu->price, 0, '', ',') }}
                                    VND</span>
                            </div>
                        </center>
                    </div>
